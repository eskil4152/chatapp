...
class AzureMonitorMetricsConfig {
    ...
    fun azureMonitorMeterRegistry(
        @Value("\${APPLICATIONINSIGHTS_CONNECTION_STRING:InstrumentationKey=00000000-0000-0000-0000-000000000000;IngestionEndpoint=https://westeurope-0.in.applicationinsights.azure.com/}")
